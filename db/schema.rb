...
ActiveRecord::Schema.define(version: 20150723103601) do
  ...
  create_table "matrix_security_users", force: :cascade do |t|
  ...
  add_index "matrix_security_users", ["email"], name: "index_matrix_security_users_on_email", unique: true, using: :btree
  add_index "matrix_security_users", ["reset_password_token"], name: "index_matrix_security_users_on_reset_password_token", unique: true, using: :btree
  add_index "matrix_security_users", ["unlock_token"], name: "index_matrix_security_users_on_unlock_token", unique: true, using: :btree
